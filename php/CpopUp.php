...
$fetchInfo = mysqli_query($conn, "SELECT * FROM `completedrequest` WHERE `id` = '$id' LIMIT 1");
    ...
    if ($fetchUser && mysqli_num_rows($fetchUser) > 0) {
        ...
        <div class="wrapper">
            ...
            <div class="action-buttons">
                <a href="./php/pending.php?orderID=' . $id . '" class="pending">Mark as Pending <i class="fal fa-seal-exclamation "></i></a>
