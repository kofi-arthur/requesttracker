...
<head>
    ...
    <title>Request Tracker - My Account</title>
...
<body>
    ...
    <section class="main">
            ...
            <form action="#">
                <div class="multiField">
                    <div class="field">
                        ...
                        <input type="text" name="firstName" id="firstName" readonly="readonly" value="<?php echo $firstname ?>" required="required">
                    </div>
                    <div class="field">
                        <label for="lastName">Last Name</label>
                        <input type="text" name="lastName" id="lastName" readonly="readonly" value="<?php echo $lastname ?>" required="required">
                    </div>
                </div>
                <div class="multiField">
                    <div class="field">
                    ...
                    <div class="field">
                        ...
                        <input type="text" name="department" id="department" value="<?php echo $userData['department'] ?>" readonly="readonly" required="required">
                    </div>
                </div>
            </form>
        </div>
        ...
        <div class="type">
            ...
            <form action="./php/changePasswordC.php" method="POST">
                <!-- hidden info -->
    ...
    <form class="ppContainer hidden" action="./php/changeppC.php" method="POST" enctype="multipart/form-data" id="closePP">
        <div class="wrapper">
            <!-- hidden inputs -->
            <input type="hidden" name="email" value="<?php echo $userData['email']; ?>" readonly>
