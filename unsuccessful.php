...
$fetchAll = mysqli_query($conn, "SELECT * FROM `unsuccessfulrequest` WHERE `email` = '$useremail'");
        ...
        <div class="tableContainer">
            ...
            <table>
                ...
                <tbody>
                    ...
                    ?>
                            <tr onclick="window.location.href='./php/UpopUpC.php?orderID=<?php echo $result['id'] ?>'">
