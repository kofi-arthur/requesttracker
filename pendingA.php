...
$pendingRequest = mysqli_query($conn, "SELECT * FROM `pendingrequest` ORDER BY `time` DESC");
            ...
            <table>
                ...
                ?>
                    <tbody>
                        ...
                        ?>
                            <tr onclick="window.location.href='./php/Ppopup.php?orderID=<?php echo $result['id'] ?>'">
